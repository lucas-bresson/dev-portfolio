import iconBrandRecognition from '@images/shortly/icon-brand-recognition.svg';
import iconDetailedRecords from '@images/shortly/icon-detailed-records.svg';
import iconFullyCustomizable from '@images/shortly/icon-fully-customizable.svg';
