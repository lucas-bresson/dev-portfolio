import logo from '@images/bookmark/logo-bookmark.svg';
  ...
  return (
    <nav className="container relative mx-auto p-6">
      <div className="my-6 flex items-center justify-between space-x-20">
        ...
        <div className="hidden items-center space-x-10 uppercase text-fadedSteel md:flex">
      ...
      <div
        ...
        } m-h-screen h-full w-full flex-col items-center divide-y divide-gray-500 self-end bg-shadowyNavy px-6 py-1 pb-4 pt-24 uppercase tracking-widest text-white opacity-90`}
      >
