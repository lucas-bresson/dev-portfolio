import logoChrome from '@images/bookmark/logo-chrome.svg';
import logoFirefox from '@images/bookmark/logo-firefox.svg';
import logoOpera from '@images/bookmark/logo-opera.svg';
