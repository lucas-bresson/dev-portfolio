import illustrationHero from '@images/bookmark/illustration-hero.svg';
    ...
    <section id="hero">
      <div className="container mx-auto flex flex-col-reverse p-6 lg:mb-0 lg:flex-row">
        <div className="flex flex-col space-y-10 lg:mt-16 lg:w-1/2">
          ...
          <p className="max-x-md mx-auto text-center text-lg text-fadedSteel lg:mx-0 lg:mt-0 lg:text-left lg:text-2xl">
