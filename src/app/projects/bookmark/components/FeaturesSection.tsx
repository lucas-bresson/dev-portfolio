import imagePanel1 from '@images/bookmark/illustration-features-tab-1.svg';
import imagePanel2 from '@images/bookmark/illustration-features-tab-2.svg';
import imagePanel3 from '@images/bookmark/illustration-features-tab-3.svg';
    ...
    <>
      <section id="features">
        <div className="container mx-auto mt-16 px-6">
          ...
          <p className="mx-auto max-w-md text-center text-fadedSteel">
          ...
          <div id="panels" className="container mx-auto">
            ...
            >
              ...
              <div className="flex flex-col space-y-8 md:w-1/2">
                ...
                <p className="text-center text-fadedSteel md:text-left">
