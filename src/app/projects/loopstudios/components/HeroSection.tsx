...
export default function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="bg-[url('/assets/images/loopstudios/mobile/image-hero.jpg')] bg-cover bg-no-repeat md:bg-[url('/assets/images/loopstudios/desktop/image-hero.jpg')]"
    >
      <div className="container mx-auto max-w-6xl px-6 py-12">
        ...
        <div
          ...
          } h-3/6 w-full flex-col space-y-3 self-end bg-black py-1 pl-12 pt-40 text-lg uppercase text-white`}
        >
