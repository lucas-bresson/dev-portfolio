import iconFacebook from '@images/loopstudios/icon-facebook.svg';
import iconInstagram from '@images/loopstudios/icon-instagram.svg';
import iconPinterest from '@images/loopstudios/icon-pinterest.svg';
import iconTwitter from '@images/loopstudios/icon-twitter.svg';
import logo from '@images/loopstudios/logo.svg';
